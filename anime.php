<?php
    ...
    $anime_names = ['Dragon Ball', 'Gintama', 'Slam Dunk', 'Assassination Classroom', 'Naruto', 'One Piece'];
?>
...
<head>
    ...
    <title>Anime Photo Gallery</title>
...
<body>
    ...
    <main>
        ...
        <div class="container mt-3 mb-5 bg-light bg-gradient p-3 shadow-lg rounded-5">
            <h3 class="fw-bold fs-1 text-center mb-3">Anime Photo Gallery</h3>
        
            <?php $i = 0 ?>
            <div class="row g-3">
                <?php foreach($anime_imgs as $id => $img_src): ?>
                    <div class="col-md-4 col-sm-6">
                        <a href="photos/<?=  $img_src ?>"  data-lightbox="anime-gallery" data-title="<?= $anime_names[$i++] ?>">
